...
%\headerbox{}
%{name=bottomlogos2, span=2, column=0, boxheaderheight=1.5mm, boxColorOne=white, headerColorOne=white, headerColorTwo=white, above=bottom}{
%\begin{center}
%\footerfont
%ICFO $\cdot$ The Institute of Photonic Sciences | Av. Carl Friedrich Gauss, 3 $\cdot$ Castelldefels $\cdot$ Barcelona
%\end{center}
...
%\headerbox{}
%{name=bottomlogos, span=2, column=0, boxheaderheight=1.5mm, boxColorOne=white, headerColorOne=white, headerColorTwo=white, above=bottomlogos2, aligned=bottom}{
%\newlength{\logoheight}
%\setlength{\logoheight}{8mm}
%\begin{center}
%\begin{tabular}{cccccccc}
