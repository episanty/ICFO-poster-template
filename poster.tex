...
%%%%%%%%%
%
%  This box contains the trustee logos. 
%
%  These logos are mandatory for posters which will be displayed 
%  in the ICFO hall, but you can edit or remove it if you're 
%  preparing a poster that will be presented externally.
%
%
\headerbox{}
...
%%%%%%%%%%%%%%%%%
%
%  The tables below contain funder logos.
%
%  The specific logos here are a suggestion - you can change this to
%  whatever logos your group and funding requires, both for externally-
%  presented posters as well as posters presented in the ICFO hall.
%
\begin{tabular}{llll}
...
%%%%%%%%%%%%%%%%%
%
%  The address footer is mandatory for posters presented in the
%  ICFO hall. You can edit it or remove it if you're presenting
%  externally.
%
\vspace{2mm}
\footerfont
